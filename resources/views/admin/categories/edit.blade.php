...
<div class="w-full max-w-xs">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('categories.update', ['category' => $category->id]) }}" method="POST">
        @method('PUT')
      ...
      <div class="mb-4">
        ...
        id="name" type="text" placeholder="Name" name="name" value="{{ old('name', $category->name) }}">
      </div>
