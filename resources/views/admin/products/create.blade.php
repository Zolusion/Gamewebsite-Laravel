...
<div class="w-full max-w-xs">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('products.store') }}" method="POST">
      ...
      <div class="mb-4">
        ...
        name="price" id="price" value="{{ old('price') }}" type="text" required>
      </div>
      ...
      <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight 
      focus:outline-none focus:shadow-outline @error('file') border-red-500 @enderror" 
      name="file" id="file" value="{{ old('file') }}" type="file" required>
    </div>
      ...
      <div class="flex items-center justify-between">
        <button id="submit" 
          ...
          focus:shadow-outline" type="submit">Submit
        </button>
      </div>
    </form>
  </div>
